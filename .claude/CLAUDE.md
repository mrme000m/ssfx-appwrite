...
- When creating new init scripts for third-party services, place them in `dev/scripts/init/ and ensure they read from a YAML config and persist values to Appwrite Database.
