"""Per-account slave — consumes structured signals and executes trades."""
...
class AccountSlave:
    ...
    async def start(self) -> None:
        if not self._config.enabled:
            _json_log("warn", "slave_disabled", name=self._config.name)
            return
        ...
        _json_log("info", "slave_ready", name=self._config.name, message="Watching for new signals...")
        ...
        _json_log("info", "slave_stopped", name=self._config.name)
