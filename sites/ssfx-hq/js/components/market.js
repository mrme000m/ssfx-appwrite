...
window.MarketComponent = (function () {
  ...
  function mount(container) {
    container.innerHTML = `
      ...
      <div class="data-grid data-grid-4">
        <div class="stat-card"><div class="stat-label">Bid</div><div class="stat-value">—</div></div>
        <div class="stat-card"><div class="stat-label">Ask</div><div class="stat-value">—</div></div>
        <div class="stat-card"><div class="stat-label">Spread</div><div class="stat-value">—</div></div>
        <div class="stat-card"><div class="stat-label">MTF Bias</div><div class="stat-value" style="font-size:1.1rem">—</div></div>
      </div>
    `;

    window.API.DataAPI.goldQuant().then((data) => {
      if (data && data.symbol) renderQuant(container, data);
    });
  }
